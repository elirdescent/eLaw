                          ...
                          <div class="joinus mt-20">
                            ...
                            <div class="mt-6">
                              <div class="rounded-md shadow">
                                <a href="{{URL('loginclient')}}" class="flex items-center justify-center w-full px-5 py-3 text-base font-medium text-white bg-gray-800 border border-transparent transition duration-300 ease-in-out rounded-md hover:bg-gray-900" target="_blank">Log In</a>
                              </div>
                            </div>
                      ...
                      <div class="mb-10 rounded-xl px-6 py-8 text-center bg-gradient-to-t from-blue-300 to-white  lg:flex-shrink-0 lg:flex lg:flex-col lg:justify-center lg:p-12" style="cursor: auto;">
                        <h3 class="text-2xl font-extrabold text-gray-900 sm:text-3xl" style="cursor: auto;">Welcome back!</h3>
                          ...
                          <div class="joinus mt-10">
                            ...
                            <div class="mt-6">
                              <div class="rounded-md shadow">
                                <a href="{{URL('adminlogin')}}" class="flex items-center justify-center w-full px-5 py-3 text-base font-medium text-white bg-gray-800 border border-transparent transition duration-300 ease-in-out rounded-md hover:bg-gray-900" target="_blank">Log In</a>
                              </div>
                            </div>
                            <div class="mt-4 text-sm text-gray-900">
                             Log in as an
